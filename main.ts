...
function createTW1() {
    ...
    // buffer length = 241
    settings.writeBuffer("TW1-TM", tm);
    // buffer length = 94
...
4c3f6c3f4c3f6c4f3c4f3c7f1cff1f`);
    // buffer length = 147
    settings.writeBuffer("TW1-FS1", fs1);
    // buffer length = 112
...
542e1f1e441e1f1e641e1f1e443e641e1f2e342e1f1e347e144e1f4e2f1e1f3e`);
    // buffer length = 147
    settings.writeBuffer("TW1-FS3", fs3);
...
f4ff004100000101ffffff`);
    // buffer length = 23
    settings.writeBuffer("TW1-RL4", hex`
f4ff02450000820c0c900000d00000c00000000001ffff`);
    // buffer length = 23
    settings.writeBuffer("TW1-RL5", hex`
f4ff12450000d20c0c900000800000c00000001001ffff`);
    // buffer length = 14
